...
import org.apache.commons.lang3.StringUtils;   //BRYAN STEVEN HERNANDEZ POLIO HP240512
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    /**
     * Customize the response for generic Exception.
     */
    ...
    /**
     * Build ApiErrorWrapper DTO from list of validation errors.
     */
    ...
    // Falta método createResponseEntity, si lo tienes en otro archivo, ignora esto.
    private ResponseEntity<Object> createResponseEntity(Exception ex, HttpHeaders headers,
